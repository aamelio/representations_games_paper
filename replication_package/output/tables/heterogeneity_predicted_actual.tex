...
\end{tabular}
\begin{flushleft}
\footnotesize Notes: Player 1, classified responses only. Predicted values reweight the category-conditional action distributions (means and variances pooled across the two arms of each comparison) by each arm's category shares; the predicted effect is the mixture implication of the representation shift alone. Actual values are the raw arm differences.
\end{flushleft}
\end{table}
